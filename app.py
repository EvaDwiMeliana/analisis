...
def is_table_empty(table, host='localhost', user='root', password='', database='analisis'):
...
def read_mysql_table(table, host='localhost', user='root', password='', database='analisis'):
    # Establish a connection to the MySQL database
    connection = pymysql.connect(
        host=host,
        user=user,
...
if not is_table_empty(table_name):
    ...
    def delete_all_data_from_table(table, host='localhost', user='root', password='', database='analisis'):
        # Establish a connection to the MySQL database
        connection = pymysql.connect(
            host=host,
            user=user,
    ...
    def insert_df_into_hasil_model(df, host='localhost', user='root', password='', database='analisis'):
        # Establish a connection to the MySQL database
        connection = pymysql.connect(
            host=host,
            user=user,
